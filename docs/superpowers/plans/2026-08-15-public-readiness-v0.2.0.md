...
- Apache-2.0 is the selected project license and `LICENSE` is committed; repository visibility remains a separate owner action.
...
- [x] **Step 7: Apply the owner-selected license**

Add the official Apache License 2.0 text at repository root, use Apache-2.0 package metadata/classifiers, and update README, CONTRIBUTING, CHANGELOG, and release documentation. Do not leave any pending-license blocker or contradictory license statement.
...
- [x] **Step 10: Check license/publication gate**

Confirm `LICENSE` contains the official Apache License 2.0 text and metadata is consistent. Public visibility remains a separate owner action; this plan does not change repository visibility.
...
Do not mark Ready if any #105–#110 acceptance criterion is incomplete or an exact-head automated/browser test is failing. Apache-2.0 licensing is complete on this branch; repository visibility remains owner-controlled.
...
- [x] Apache-2.0 is the explicit owner-selected license and the official `LICENSE` file is present.
