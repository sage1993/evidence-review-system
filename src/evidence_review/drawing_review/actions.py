...
from evidence_review.contracts.drawing import Geometry, decode_geometry
...
from evidence_review.parsing.drawing_confirmation import parse_confirmation_time
...
type AnnotationAction = ExistingCandidateAction | ManualCreateAction
