...
type GoldenStatus = Literal["PASS", "FAIL"]
type ActivationStatus = Literal["ACTIVATED", "BLOCKED"]
type SelectionStatus = Literal["SELECTED", "ABSTAIN", "BLOCKED"]
type ExclusionCode = Literal["MISSING_SCOPE_VALUE", "SCOPE_MISMATCH"]
