...
from evidence_review.offline_policy import OfflinePolicy, default_offline_policy
...
def _policy_path(resolved_root: Path, relative_path: str) -> str:
    ...
    if relative_path.startswith("evidence_review/"):
        return relative_path
    if resolved_root.name == "evidence_review":
        return f"evidence_review/{relative_path}"
    return relative_path
