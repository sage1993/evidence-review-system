...
def _comparison_api() -> Any:
    ...
    if not hasattr(module, "evaluate_fact_rule_comparisons"):
        pytest.fail("evaluate_fact_rule_comparisons is not implemented", pytrace=False)
    return module
...
def test_global_area_fact_is_compared_only_for_issue_that_preserves_1500_value() -> None:
    ...
    comparisons = module.evaluate_fact_rule_comparisons(plan, bundle, facets)
