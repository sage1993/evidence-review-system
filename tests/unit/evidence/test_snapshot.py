...
def test_finalized_provenance_uses_exact_closed_database_file_bytes(
    tmp_path: Path,
) -> None:
    ...
    provenance = getattr(snapshot, "finalized_evidence_provenance", None)
    if provenance is None:
        pytest.fail("finalized_evidence_provenance is not implemented", pytrace=False)
